...
-- -----------------------------------------------------
-- Table `sweproj`.`PERSON_PhoneNumber`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sweproj`.`PERSON_PhoneNumber` ;

CREATE TABLE IF NOT EXISTS `sweproj`.`PERSON_PhoneNumber` (
  `PersonID` INT NOT NULL,
  `PhoneNumber` VARCHAR(45) NULL,
  PRIMARY KEY (`PersonID`),
  CONSTRAINT `fk_PERSON_PhoneNumber_PERSON1`
...
CREATE TABLE IF NOT EXISTS `sweproj`.`SERVICE_made for_GUEST` (
  ...
  CONSTRAINT `fk_SERVICE_has_GUEST_SERVICE1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_SERVIC/home/ubuntu/IdeaProjects/sweproj/database/sweproj.sqlE_has_GUEST_GUEST1`
    FOREIGN KEY (`GuestID`)
    REFERENCES `sweproj`.`GUEST` (`GuestID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
